...
class PlaylistSubscribersEntity {
	...
	factory PlaylistSubscribersEntity.fromJson(Map<String, dynamic> json) => $PlaylistSubscribersEntityFromJson(json);

	Map<String, dynamic> toJson() => $PlaylistSubscribersEntityToJson(this);

	PlaylistSubscribersEntity copyWith({int? total, int? code, bool? more, List<PlaylistSubscribersSubscribers>? subscribers}) {
