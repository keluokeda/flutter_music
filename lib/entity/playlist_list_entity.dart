...
class PlaylistListEntity {
	...
	factory PlaylistListEntity.fromJson(Map<String, dynamic> json) => $PlaylistListEntityFromJson(json);

	Map<String, dynamic> toJson() => $PlaylistListEntityToJson(this);

	PlaylistListEntity copyWith({List<PlaylistListPlaylists>? playlists, int? total, int? code, bool? more, String? cat}) {
...
class PlaylistListPlaylists {
	...
	factory PlaylistListPlaylists.fromJson(Map<String, dynamic> json) => $PlaylistListPlaylistsFromJson(json);

	Map<String, dynamic> toJson() => $PlaylistListPlaylistsToJson(this);

	PlaylistListPlaylists copyWith({String? name, int? id, int? trackNumberUpdateTime, int? status, int? userId, int? createTime, int? updateTime, int? subscribedCount, int? trackCount, int? cloudTrackCount, String? coverImgUrl, int? coverImgId, String? description, List<String>? tags, int? playCount, int? trackUpdateTime, int? specialType, int? totalDuration, PlaylistListPlaylistsCreator? creator, dynamic tracks, List<PlaylistListPlaylistsSubscribers>? subscribers, bool? subscribed, String? commentThreadId, bool? newImported, int? adType, bool? highQuality, int? privacy, bool? ordered, bool? anonimous, int? coverStatus, dynamic recommendInfo, dynamic socialPlaylistCover, dynamic recommendText, int? shareCount, String? coverimgidStr, String? alg, int? commentCount}) {
...
class PlaylistListPlaylistsCreator {
	...
	factory PlaylistListPlaylistsCreator.fromJson(Map<String, dynamic> json) => $PlaylistListPlaylistsCreatorFromJson(json);

	Map<String, dynamic> toJson() => $PlaylistListPlaylistsCreatorToJson(this);

	PlaylistListPlaylistsCreator copyWith({bool? defaultAvatar, int? province, int? authStatus, bool? followed, String? avatarUrl, int? accountStatus, int? gender, int? city, int? birthday, int? userId, int? userType, String? nickname, String? signature, String? description, String? detailDescription, int? avatarImgId, int? backgroundImgId, String? backgroundUrl, int? authority, bool? mutual, dynamic expertTags, dynamic experts, int? djStatus, int? vipType, dynamic remarkName, int? authenticationTypes, PlaylistListPlaylistsCreatorAvatarDetail? avatarDetail, String? avatarImgIdStr, String? backgroundImgIdStr, bool? anchor, String? avatarimgidStr}) {
...
class PlaylistListPlaylistsCreatorAvatarDetail {
	...
	factory PlaylistListPlaylistsCreatorAvatarDetail.fromJson(Map<String, dynamic> json) => $PlaylistListPlaylistsCreatorAvatarDetailFromJson(json);

	Map<String, dynamic> toJson() => $PlaylistListPlaylistsCreatorAvatarDetailToJson(this);

	PlaylistListPlaylistsCreatorAvatarDetail copyWith({int? userType, int? identityLevel, String? identityIconUrl}) {
...
class PlaylistListPlaylistsSubscribers {
	...
	factory PlaylistListPlaylistsSubscribers.fromJson(Map<String, dynamic> json) => $PlaylistListPlaylistsSubscribersFromJson(json);

	Map<String, dynamic> toJson() => $PlaylistListPlaylistsSubscribersToJson(this);

	PlaylistListPlaylistsSubscribers copyWith({bool? defaultAvatar, int? province, int? authStatus, bool? followed, String? avatarUrl, int? accountStatus, int? gender, int? city, int? birthday, int? userId, int? userType, String? nickname, String? signature, String? description, String? detailDescription, int? avatarImgId, int? backgroundImgId, String? backgroundUrl, int? authority, bool? mutual, dynamic expertTags, dynamic experts, int? djStatus, int? vipType, dynamic remarkName, int? authenticationTypes, dynamic avatarDetail, String? avatarImgIdStr, String? backgroundImgIdStr, bool? anchor}) {
